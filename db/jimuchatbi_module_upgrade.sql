/*
 ...
 Source Schema         : jimureport_os

 Target Server Type    : MySQL
 Target Server Version : 50738 (5.7.38)
 File Encoding         : 65001

 Date: 09/08/2026 19:32:19
*/
...
-- ----------------------------
INSERT INTO `chat2bi_conversation` VALUES ('2887ab895ff842ef8a294f7573da6f74', '956f9607116047ada54619734d85f99f', '6a01a7bce0174875a413f60e5bdec16b', '各大区的保费排名', 'admin', '2026-05-24 09:00:00', NULL, '2026-08-09 17:43:29', 0);
...
INSERT INTO `chat2bi_message` VALUES ('08a45d0ef9fe4c0cab276300aa5205ec', '2887ab895ff842ef8a294f7573da6f74', 'ai', '已理解你的问题，按下面的口径为你取数（可直接调整）：', '{\"role\":\"ai\",\"text\":\"已理解你的问题，按下面的口径为你取数（可直接调整）：\",\"dsl\":{\"metric\":\"保费合计\",\"dimension\":\"大区\",\"time\":\"全部\",\"filter\":\"\"},\"detail\":false,\"columns\":[\"大区\",\"保费合计\"],\"data\":[[\"华东\",\"627604.31\"],[\"华北\",\"622788.42\"],[\"西南\",\"466631.17\"],[\"华南\",\"391663.45\"],[\"华中\",\"263998.94\"],[\"西北\",\"233384.62\"]],\"sql\":\"SELECT c.region AS \\\"大区\\\", SUM(p.premium) AS \\\"保费合计\\\" FROM ins_policy p LEFT JOIN ins_customer c ON p.cust_id = c.id GROUP BY c.region ORDER BY SUM(p.premium) DESC LIMIT 50\",\"insight\":\"「华东」的保费合计最高（627604.31），本次共返回 6 组数据。\",\"chart\":true,\"chartType\":\"bar\",\"followup\":false,\"sumCols\":[\"保费合计\"],\"colMap\":{\"大区\":\"region\",\"保费合计\":\"\"},\"domainId\":\"6a01a7bce0174875a413f60e5bdec16b\",\"dslExtraMetrics\":[],\"dslExtraDimensions\":[\"大区\"]}', 21, '2026-08-09 17:43:29');
INSERT INTO `chat2bi_message` VALUES ('10590167e42d441b8e55fb8abd2779ea', '2887ab895ff842ef8a294f7573da6f74', 'ai', '已理解你的问题，按下面的口径为你取数（可直接调整）：', '{\"role\":\"ai\",\"text\":\"已理解你的问题，按下面的口径为你取数（可直接调整）：\",\"dsl\":{\"metric\":\"保费总额\",\"dimension\":\"客户等级\",\"time\":\"全部\",\"filter\":\"\"},\"detail\":false,\"columns\":[\"客户等级\",\"保费总额\"],\"data\":[[\"银卡\",\"397266.10\"],[\"金卡\",\"527151.40\"],[\"白金\",\"798831.77\"],[\"普通\",\"882821.64\"]],\"sql\":\"SELECT c.cust_level AS \\\"客户等级\\\", SUM(p.premium) AS \\\"保费总额\\\" FROM ins_policy p LEFT JOIN ins_customer c ON p.cust_id = c.id GROUP BY c.cust_level ORDER BY \\\"保费总额\\\" DESC LIMIT 50\",\"insight\":\"「银卡」的保费总额最高（397266.10），本次共返回 4 组数据。\",\"chart\":true,\"chartType\":\"bar\",\"followup\":false,\"sumCols\":[\"保费总额\"],\"colMap\":{\"客户等级\":\"cust_level\",\"保费总额\":\"\"},\"domainId\":\"6a01a7bce0174875a413f60e5bdec16b\",\"dslExtraMetrics\":[\"保费总额\"],\"dslExtraDimensions\":[\"客户等级\"]}', 15, '2026-08-09 17:43:29');
...
INSERT INTO `chat2bi_message` VALUES ('19e9c60fd76347cbbaf7c0905580284b', '2887ab895ff842ef8a294f7573da6f74', 'user', '查询白金客户的明细', '{\"role\":\"user\",\"text\":\"查询白金客户的明细\"}', 4, '2026-08-09 17:43:29');
...
INSERT INTO `chat2bi_message` VALUES ('1cf9b05dbc534a23b9e0ca9b761b072d', '2887ab895ff842ef8a294f7573da6f74', 'user', '各大区的保费排名', '{\"role\":\"user\",\"text\":\"各大区的保费排名\"}', 20, '2026-08-09 17:43:29');
INSERT INTO `chat2bi_message` VALUES ('20971d2adf284fdc92281c937edaff2e', '2887ab895ff842ef8a294f7573da6f74', 'ai', '已理解你的问题，按下面的口径为你取数（可直接调整）：', '{\"role\":\"ai\",\"text\":\"已理解你的问题，按下面的口径为你取数（可直接调整）：\",\"dsl\":{\"metric\":\"保费合计\",\"dimension\":\"大区\",\"time\":\"全部\",\"filter\":\"\"},\"detail\":false,\"columns\":[\"大区\",\"保费合计\"],\"data\":[[\"华东\",\"627604.31\"],[\"华北\",\"622788.42\"],[\"西南\",\"466631.17\"],[\"华南\",\"391663.45\"],[\"华中\",\"263998.94\"],[\"西北\",\"233384.62\"]],\"sql\":\"SELECT region AS \\\"大区\\\", SUM(premium) AS \\\"保费合计\\\" FROM ins_policy GROUP BY region ORDER BY SUM(premium) DESC LIMIT 50\",\"insight\":\"「华东」的保费合计最高（627604.31），本次共返回 6 组数据。\",\"chart\":true,\"chartType\":\"bar\",\"followup\":false,\"sumCols\":[\"保费合计\"],\"colMap\":{\"大区\":\"region\",\"保费合计\":\"\"},\"domainId\":\"6a01a7bce0174875a413f60e5bdec16b\",\"dslExtraMetrics\":[],\"dslExtraDimensions\":[\"大区\"]}', 13, '2026-08-09 17:43:29');
...
INSERT INTO `chat2bi_message` VALUES ('33528a1a695441fba44ae7be7e31fef3', '2887ab895ff842ef8a294f7573da6f74', 'user', '已赔付理赔金额按险种汇总', '{\"role\":\"user\",\"text\":\"已赔付理赔金额按险种汇总\"}', 18, '2026-08-09 17:43:29');
...
INSERT INTO `chat2bi_message` VALUES ('45e8941d342641c7aa19a7630851f06f', '2887ab895ff842ef8a294f7573da6f74', 'user', '各险种的保费总额', '{\"role\":\"user\",\"text\":\"各险种的保费总额\"}', 6, '2026-08-09 17:43:29');
...
INSERT INTO `chat2bi_message` VALUES ('5313f37d9bee4bcbb1fba7eeecfd5f15', '2887ab895ff842ef8a294f7573da6f74', 'user', '各大区的保费排名', '{\"role\":\"user\",\"text\":\"各大区的保费排名\"}', 0, '2026-08-09 17:43:29');
...
INSERT INTO `chat2bi_message` VALUES ('5fba3ea6d0184955804fc1e8b5b3c822', '2887ab895ff842ef8a294f7573da6f74', 'ai', '已理解你的问题，为你查询到以下明细数据：', '{\"role\":\"ai\",\"text\":\"已理解你的问题，为你查询到以下明细数据：\",\"dsl\":{\"metric\":\"保单状态\",\"dimension\":\"保单ID\",\"time\":\"全部\",\"filter\":\"\"},\"detail\":true,\"columns\":[\"保单ID\",\"保单号\",\"客户姓名\",\"险种名称\",\"年保费\",\"保额\",\"投保日期\",\"保单状态\"],\"data\":[[\"200116\",\"P200116\",\"郑梓涵\",\"商业车险全保\",\"17997.47\",\"1350869.03\",\"2024-01-25\",\"已过期\"],[\"200033\",\"P200033\",\"宋宇勇\",\"好医保长期医疗\",\"17962.57\",\"1588838.64\",\"2024-11-08\",\"生效\"],[\"200130\",\"P200130\",\"郭玲\",\"雇主责任险\",\"17899.36\",\"812303.59\",\"2024-01-17\",\"生效\"],[\"200170\",\"P200170\",\"田洋\",\"车损险尊享\",\"17843.61\",\"1979911.50\",\"2025-12-21\",\"生效\"],[\"200290\",\"P200290\",\"梁磊\",\"少儿门诊医疗\",\"17768.79\",\"385975.90\",\"2025-01-20\",\"生效\"],[\"200045\",\"P200045\",\"曾娜\",\"商业车险全保\",\"17711.83\",\"1973682.71\",\"2023-04-01\",\"已过期\"],[\"200095\",\"P200095\",\"肖勇\",\"商业车险全保\",\"17599.99\",\"779816.14\",\"2025-10-11\",\"生效\"],[\"200101\",\"P200101\",\"罗强\",\"雇主责任险\",\"17537.99\",\"429642.99\",\"2026-03-28\",\"生效\"],[\"200015\",\"P200015\",\"袁嘉怡\",\"综合意外险\",\"17508.37\",\"1258736.91\",\"2023-12-26\",\"已过期\"],[\"200171\",\"P200171\",\"苏芳浩然\",\"百万守护意外险\",\"17422.52\",\"578822.53\",\"2023-06-25\",\"生效\"]],\"sql\":\"SELECT id AS 保单ID, policy_no AS 保单号, cust_name AS 客户姓名, product_name AS 险种名称, premium AS 年保费, coverage_amount AS 保额, sign_date AS 投保日期, status AS 保单状态 FROM ins_policy ORDER BY premium DESC LIMIT 10\",\"insight\":\"共查询到 10 条记录，8 个字段。\",\"chart\":false,\"chartType\":\"柱状图\",\"followup\":false}', 3, '2026-08-09 17:43:29');
...
INSERT INTO `chat2bi_message` VALUES ('76d50d4f6f2f4cbebd85402547e63a53', '2887ab895ff842ef8a294f7573da6f74', 'user', '各客户等级的保费总额', '{\"role\":\"user\",\"text\":\"各客户等级的保费总额\"}', 14, '2026-08-09 17:43:29');
...
INSERT INTO `chat2bi_message` VALUES ('7cbeef2dcbb44e829d5e2f830a193f20', '2887ab895ff842ef8a294f7573da6f74', 'ai', '已理解你的问题，按下面的口径为你取数（可直接调整）：', '{\"role\":\"ai\",\"text\":\"已理解你的问题，按下面的口径为你取数（可直接调整）：\",\"dsl\":{\"metric\":\"保费总额\",\"dimension\":\"客户等级\",\"time\":\"全部\",\"filter\":\"\"},\"detail\":false,\"columns\":[\"客户等级\",\"保费总额\"],\"data\":[[\"普通\",\"882821.64\"],[\"白金\",\"798831.77\"],[\"金卡\",\"527151.40\"],[\"银卡\",\"397266.10\"]],\"sql\":\"SELECT c.cust_level AS \\\"客户等级\\\", SUM(p.premium) AS \\\"保费总额\\\" FROM ins_policy p LEFT JOIN ins_customer c ON p.cust_id = c.id GROUP BY c.cust_level ORDER BY SUM(p.premium) DESC LIMIT 50\",\"insight\":\"「普通」的保费总额最高（882821.64），本次共返回 4 组数据。\",\"chart\":true,\"chartType\":\"bar\",\"followup\":false,\"sumCols\":[\"保费总额\"],\"colMap\":{\"客户等级\":\"cust_level\",\"保费总额\":\"\"},\"domainId\":\"6a01a7bce0174875a413f60e5bdec16b\",\"dslExtraMetrics\":[\"保费总额\"],\"dslExtraDimensions\":[\"客户等级\"]}', 17, '2026-08-09 17:43:29');
INSERT INTO `chat2bi_message` VALUES ('7d21d1f6c84b40c78d6dd57a81ac02a2', '2887ab895ff842ef8a294f7573da6f74', 'ai', '已理解你的问题，按下面的口径为你取数（可直接调整）：', '{\"role\":\"ai\",\"text\":\"已理解你的问题，按下面的口径为你取数（可直接调整）：\",\"dsl\":{\"metric\":\"保单数量\",\"dimension\":\"销售渠道\",\"time\":\"全部\",\"filter\":\"\"},\"detail\":false,\"columns\":[\"销售渠道\",\"保单数量\"],\"data\":[[\"代理人\",\"67\"],[\"电销\",\"62\"],[\"经纪\",\"50\"],[\"线上直销\",\"53\"],[\"银保\",\"68\"]],\"sql\":\"SELECT channel AS \\\"销售渠道\\\", COUNT(*) AS \\\"保单数量\\\" FROM ins_policy GROUP BY channel ORDER BY \\\"保单数量\\\" DESC LIMIT 50\",\"insight\":\"「代理人」的保单数量最高（67），本次共返回 5 组数据。\",\"chart\":true,\"chartType\":\"bar\",\"followup\":false,\"sumCols\":[\"保单数量\"],\"colMap\":{\"销售渠道\":\"channel\",\"保单数量\":\"\"},\"domainId\":\"6a01a7bce0174875a413f60e5bdec16b\",\"dslExtraMetrics\":[\"保单数量\"],\"dslExtraDimensions\":[\"销售渠道\"]}', 9, '2026-08-09 17:43:29');
...
INSERT INTO `chat2bi_message` VALUES ('867a560e3ecd42c1ab6e29a9fffddfc6', '2887ab895ff842ef8a294f7573da6f74', 'user', '保费最高的10张保单明细', '{\"role\":\"user\",\"text\":\"保费最高的10张保单明细\"}', 2, '2026-08-09 17:43:29');
...
INSERT INTO `chat2bi_message` VALUES ('a3f7bb54968b47b1b12a938c67a1a729', '2887ab895ff842ef8a294f7573da6f74', 'blocked', '查询涉及的表 ins_claim 在当前数据库中不存在，无法生成有效SQL。', '{\"role\":\"blocked\",\"text\":\"查询涉及的表 ins_claim 在当前数据库中不存在，无法生成有效SQL。\",\"blocked\":true,\"detail\":false,\"columns\":[],\"data\":[],\"sql\":\"\",\"insight\":\"\",\"chart\":false,\"chartType\":\"\",\"followup\":false}', 19, '2026-08-09 17:43:29');
INSERT INTO `chat2bi_message` VALUES ('aa6c663a968d45b1a6e7dc8d198e3fce', '2887ab895ff842ef8a294f7573da6f74', 'user', '各大区的保费排名', '{\"role\":\"user\",\"text\":\"各大区的保费排名\"}', 12, '2026-08-09 17:43:29');
INSERT INTO `chat2bi_message` VALUES ('ac38978f21c7421d944d4d9cf72fa1e4', '2887ab895ff842ef8a294f7573da6f74', 'user', '各渠道的保单数量', '{\"role\":\"user\",\"text\":\"各渠道的保单数量\"}', 8, '2026-08-09 17:43:29');
...
INSERT INTO `chat2bi_message` VALUES ('d7c159735e3b4c1a9a885b63f161ee60', '2887ab895ff842ef8a294f7573da6f74', 'ai', '已理解你的问题，按下面的口径为你取数（可直接调整）：', '{\"role\":\"ai\",\"text\":\"已理解你的问题，按下面的口径为你取数（可直接调整）：\",\"dsl\":{\"metric\":\"保费\",\"dimension\":\"大区\",\"time\":\"全部\",\"filter\":\"\",\"limit\":100},\"data\":[[\"华东\",\"627,604\"],[\"华北\",\"622,788\"],[\"西南\",\"466,631\"],[\"华南\",\"391,663\"],[\"华中\",\"263,998\"],[\"西北\",\"233,384\"]],\"sql\":\"SELECT region, SUM(premium) AS premium_sum\\nFROM ins_policy\\nGROUP BY region\\nORDER BY 2 DESC\",\"insight\":\"「华东」的保费最高（627,604），约占总量的 24%。\",\"chart\":false,\"chartType\":\"柱状图\",\"followup\":false}', 1, '2026-08-09 17:43:29');
INSERT INTO `chat2bi_message` VALUES ('dfdee3a4d6f845d19e41180b33f5f073', '2887ab895ff842ef8a294f7573da6f74', 'ai', '已理解你的问题，按下面的口径为你取数（可直接调整）：', '{\"role\":\"ai\",\"text\":\"已理解你的问题，按下面的口径为你取数（可直接调整）：\",\"dsl\":{\"metric\":\"保费总额\",\"dimension\":\"险种类型\",\"time\":\"全部\",\"filter\":\"\"},\"detail\":false,\"columns\":[\"险种类型\",\"保费总额\"],\"data\":[[\"财产险\",\"624703.92\"],[\"意外险\",\"530727.44\"],[\"寿险\",\"504139.35\"],[\"健康险\",\"488370.47\"],[\"车险\",\"458129.73\"]],\"sql\":\"SELECT product_type AS 险种类型, SUM(premium) AS 保费总额 FROM ins_policy GROUP BY product_type ORDER BY 保费总额 DESC LIMIT 50\",\"insight\":\"「财产险」的保费总额最高（624703.92），本次共返回 5 组数据。\",\"chart\":false,\"chartType\":\"柱状图\",\"followup\":false}', 7, '2026-08-09 17:43:29');
...
INSERT INTO `chat2bi_message` VALUES ('f2a4ab095bcf4533b09422511653458a', '2887ab895ff842ef8a294f7573da6f74', 'user', '各险种的保费总额', '{\"role\":\"user\",\"text\":\"各险种的保费总额\"}', 10, '2026-08-09 17:43:29');
...
-- ----------------------------
-- Table structure for chat2bi_table_meta
-- ----------------------------
DROP TABLE IF EXISTS `chat2bi_table_meta`;
...
-- ----------------------------
-- Records of chat2bi_table_meta
-- ----------------------------

-- ----------------------------
-- Table structure for chat2bi_term
-- ----------------------------
